...
impl<'a> UserMenuWidget<'a> {
    pub fn render_in(
        ...
        // border(2) + items + empty line(1) + close button(1)
        ...
        // Reserve the last inner row for the Close button, and the row above it as a blank spacer
        ...
        let close_row = inner.y + list_height + 1;
